...
### **`Results and Tests`** 
Summary of Results and comment resulting for the code. Some research work is just a means to an end so comments might include the feasibilty of practical useage of the research or feasibility of fute resaersh building on this 
