## `data`
This directory houses all small (< 100 MB) data sets that are a result of sourcing from di. Depending on the type of data collected, you may want to split them up based on file type. Data larger than 
